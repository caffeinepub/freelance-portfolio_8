...
export class Backend implements backendInterface {
    ...
    async getPortfolio(): Promise<Array<PortfolioItem>> {
        if (this.processError) {
            try {
    ...
    async getPortfolioTitles(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPortfolioTitles();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getServiceByTitle(arg0: string): Promise<Service> {
        if (this.processError) {
            try {
                const result = await this.actor.getServiceByTitle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getServiceTitles(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getServiceTitles();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
